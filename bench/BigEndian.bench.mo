...
module {
    public func init() : Bench.Bench {
        ...
        for (i in Iter.range(0, 9_999)) {
            nat8Bytes.add(ByteUtils.BigEndian.fromNat8(fuzz.nat8.random()));
            nat16Bytes.add(ByteUtils.BigEndian.fromNat16(fuzz.nat16.random()));
            nat32Bytes.add(ByteUtils.BigEndian.fromNat32(fuzz.nat32.random()));
            nat64Bytes.add(ByteUtils.BigEndian.fromNat64(fuzz.nat64.random()));
            floatBytes.add(ByteUtils.BigEndian.fromFloat(fuzz.float.random()));
            int8Bytes.add(ByteUtils.BigEndian.fromInt8(fuzz.int8.random()));
            int16Bytes.add(ByteUtils.BigEndian.fromInt16(fuzz.int16.random()));
            int32Bytes.add(ByteUtils.BigEndian.fromInt32(fuzz.int32.random()));
            int64Bytes.add(ByteUtils.BigEndian.fromInt64(fuzz.int64.random()));
